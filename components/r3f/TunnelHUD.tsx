...
function HeroCard({ station }: { station: StationDef }) {
  return (
    <>
      <FlipPhotoCard accent={station.color} />
...
// Same UX as the original Hero card but slimmed down for the tunnel HUD and
// re-tinted in the active accent (amber).
// ─────────────────────────────────────────────────────────────────────────────
function FlipPhotoCard({ accent }: { accent: string }) {
