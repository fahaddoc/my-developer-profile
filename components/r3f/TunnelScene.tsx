...
export const STATIONS: StationDef[] = [
  ...
  },
  {
    ...
    short:     'OSS',
    t:         0.63,
    heading:   'Merged into Flutter',
    tagline:   'Two pull requests merged into flutter/flutter — a clearer "setState() called after dispose()" diagnostic with a framework test, and the documented super call order for State.didChangeDependencies.',
    color:     '#5EEAD4',
    cta:       { text: 'view pull requests →', href: '/open-source' },
    subtitle:    'MERGED INTO FLUTTER',
    closer:      ['MERGED PRS', 'FLUTTER/FLUTTER'],
    traitsLeft:  ['FLUTTER', 'DART', 'FRAMEWORK'],
